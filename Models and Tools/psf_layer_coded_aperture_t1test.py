...
class Psf_layer(Layer):
    ...
    def __init__(self, output_dim, distance=50e-3, patch_size=250, sample_interval=3.69e-6, wave_resolution=500,
        ...
        if wave_lengths is not None:
            ...
            self.wave_lengths = K.cast(np.linspace(420, 660, 24)*1e-9,dtype=K.float32)
    ...
    def build(self, input_shape):
        ...
        zernike_inits[3] = -0.8  # This sets the defocus value to approximately focus the image for a distance of 1m.
        ...
        self.Mask_pattern = self.add_weight(name='mask', shape=(self.Nt,self.Nt, 31),
    ...
    def call(self, inputs, **kwargs):
        ...
        height_map = K.clip_by_value(height_map, -1.51e-6, 1.51e-6)
        height_map = height_map -K.reduce_min(height_map)
